		            		...
		            		<div class="container" id="ADMINcontainer">
		            			<!--MAIN-->
									...
									<div class="container">
										<h1>Add Items</h1>
										  <ul>
										    <li> Select the category you want to add items.</li> 
										    <li> You can remove and edit the items you added.</li>
										  </ul>
										<div class="row">
											<div class="btn-tooltip">
												<div class="col-md-12">	
											        ...
											        <div class="btn-group adminSPACE">
														<a href="#" class="btn btn-default btn-sm adminBUTTON">Click to add items</a> 	
													</div> 
												</div>      
								            </div> 
										</div>  
